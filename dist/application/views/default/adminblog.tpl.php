...
<section>
    ...
    <div class="container">
        ...
        <?php endif; ?>
            ...
            <form method="post" action="/adminblog/<?php echo $this->action; ?>/" id="artForm" enctype="multipart/form-data">
                                ...
                                <div class="card mb-2 box-shadow">
                                    <?php if(!empty($this->img)) : ?>
                                        <img class="card-img-top"
                                             ...
                                             alt="">
                                        <?php if($this->img != 'BlogDefault.jpg') : ?>
                                        <div class="ml-auto"><a title='Удалить это фото?' href='/adminblog/delillustration/url/<?php echo $this->url ?>/' onclick="return confirm('Удалить фото?');"><i class="fas fa-times text-danger mr-2" aria-hidden="true"></i></a></div>
                                        <?php endif; ?>
                    ...
                    <div id="tabs-2" class="tab-pane fade" role="tabpanel" aria-labelledby="tabs-2-tab">
                        ...
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><?php echo HTTP_PATH ?>blog/</span>
                            </div>
